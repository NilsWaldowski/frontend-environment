...
gulp.task('pl-sync', plugins.shell.task([
	// todo: path in dirs.json
	'browser-sync start --proxy "gm-pl-lab.local" --files "public/Templates/Master/Resources/Public/Css/*.css"'
]));
...
gulp.task('deploy', ['icons-deploy', 'img-dev-deploy', 'css-deploy', 'js-deploy', 'fonts-deploy'], function() {
	notifier.notify({
